...
При удалённой проверке NetBird сначала даёт доступ к хосту `10.128.0.9`, затем
клиент подключает учебный OpenVPN к `10.128.0.9:1194/UDP`. Инструкция по
установке и порядку запуска: [remote-access.md](remote-access.md).
